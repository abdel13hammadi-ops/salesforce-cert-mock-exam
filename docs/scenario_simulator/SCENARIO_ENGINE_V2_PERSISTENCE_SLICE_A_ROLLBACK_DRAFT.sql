-- =============================================================================
-- SCENARIO_ENGINE_V2 Persistence — Slice A — ROLLBACK DRAFT (NOT EXECUTABLE YET)
--
-- Task: SIM-PERSIST-V2-02A. This is a DRAFT for independent review only. Do
...
-- SCENARIO_ENGINE_V2_PERSISTENCE_SLICE_A_MIGRATION_DRAFT.sql: drops the new
-- seven-argument public.start_or_resume_scenario_attempt_v1 and recreates the
-- original six-argument function with its EXACT original body, comment, and
-- grants, byte-for-byte identical to
...
-- section 1 now dynamically captures the seven-argument function's exact
...
DECLARE
    ...
    -- the markers shared with the pre-Slice-A baseline.
